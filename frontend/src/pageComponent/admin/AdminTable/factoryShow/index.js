          ...
          content={
            <Box id={id}>
              <div className="sectionHeader" style={{ marginBottom: "20px" }}>
                <p className="sectionTitle">Блог #ЗаводШоу</p>
              </div>
              <br />
              <DataTable id={id} columns={factoryColums} data={factory} />
              {userInfo?.adding !== 0 && (
                <BlackButton
                  onClick={() => handleNewCreate("/admin/factory")}
                  title={`Добавить`}
                />
              )}
            </Box>
...
export default FactoryShowTable;
