  ...
  try {
    ...
    return {
      ...
      description:
        ...
        "Проверенный каталог площадок с готовыми решениями для любых мероприятий. Широкий выбор локаций с фильтрами и поиском.  Поможем с техническим продакшном, чтобы ваше событие прошло без лишних забот.", // Use your actual data field
      keywords:
        siteData.keyword ||
        "Каталог площадок, Площадки для мероприятий, Площадки для концертов, Локации для мероприятий, площадка для…, площадки для ивента",
    };
  } catch (error) {
